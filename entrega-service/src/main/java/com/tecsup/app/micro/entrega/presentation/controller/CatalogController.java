...
import com.tecsup.app.micro.entrega.application.service.CatalogApplicationService;
import com.tecsup.app.micro.entrega.domain.model.Catalog;
import com.tecsup.app.micro.entrega.presentation.dto.CreateCatalogRequest;
import com.tecsup.app.micro.entrega.presentation.dto.CatalogResponse;
import com.tecsup.app.micro.entrega.presentation.dto.UpdateCatalogRequest;
import com.tecsup.app.micro.entrega.presentation.mapper.CatalogDtoMapper;
...
public class CatalogController {
    ...
    public ResponseEntity<CatalogResponse> createCatalog(@Valid @RequestBody CreateCatalogRequest request) {
        ...
        Catalog createdCatalog = catalogApplicationService.createCatalog(catalog);
