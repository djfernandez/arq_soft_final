package com.tecsup.app.micro.catalogo.infrastructure.client;
...
import com.tecsup.app.micro.catalogo.infrastructure.client.mapper.UserDtoMapper;
...
public class UserClient {
     ...
     */
    @CircuitBreaker(name = "catalogoService")
    @Retry(name = "catalogoService", fallbackMethod = "getUserFallback")
