    ...
    -- Comentarios
    COMMENT ON TABLE catalogs IS 'Catálogos del sistema - DB en Docker';
    COMMENT ON COLUMN catalogs.created_by IS 'Usuario creador (ref. lógica a userdb.users.id en otro contenedor)';
